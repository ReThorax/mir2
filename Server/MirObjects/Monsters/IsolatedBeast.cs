...
{
    public class IsolatedBeast : MonsterObject
    {
        ...
        protected internal IsolatedBeast(MonsterInfo info)
            : base(info)
        {
        }
        ...
        private void AoeAttack(int area, int dmg, int time, Point location)
        {
            int damage;
