        ...
        public void SetCamera(uint objID)
        {
            ...
            if (LockedOn && !NewLock)
            {
                ...
                for (int i = MapControl.Objects.Count - 1; i >= 0; i--)
                {
                    ...
                    GameScene.Scene.StatusObserveLabel.Text = "Locked"; //Set button to show as Locked
            ...
            else if (!LockedOn)
            {
                ...
                GameScene.Scene.StatusObserveLabel.Text = "Unlocked"; //Set button to show as Unlocked
